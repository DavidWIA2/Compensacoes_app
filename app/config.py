...
MAPBOX_ENABLED = os.getenv("COMP_MAPBOX_ENABLED", "false").strip().lower() in {"1", "true", "yes", "sim"}
MAPBOX_TOKEN_ENV_VAR = os.getenv("COMP_MAPBOX_TOKEN_ENV_VAR", "MAPBOX_TOKEN").strip() or "MAPBOX_TOKEN"
